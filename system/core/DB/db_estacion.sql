...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2024 a las 15:19:37
...
INSERT INTO `table_cierre` (`id_table_cierre`, `tipo_cierre`, `cant_cierre`, `monto_cierre`, `fecha_cierre`, `id_user`) VALUES
(1, '1', '2', '85', '16-05-24', 12),
(2, '4', '1', '20', '17-05-24', 12),
(3, '1', '2', '85', '16-05-24', 12),
(4, '2', '1', '10', '17-05-24', 12),
(5, '3', '2', '22', '17-05-24', 12),
(6, '4', '4', '36', '17-05-24', 12);
...
(1, 'william enrique', '14607920', 1, NULL, 45, 4, '22.5', '36.6', '16-05-24', '16:47:28', 12, 1),
(2, 'oswaldo de jesus', '12521452', 1, '12-ñlk', 40, 4, '20', NULL, '17-05-24', '08:35:03', 12, 0),
(3, 'william enrique', '14607920', 2, '', 10, 4, '5', NULL, '17-05-24', '08:41:22', 12, 0),
(4, 'william enrique', '435435', 3, '', 2, 4, '1', NULL, '17-05-24', '08:42:48', 12, 0),
(5, 'jjbj', '546', 3, 'N/A', 20, 4, '10', NULL, '17-05-24', '08:44:33', 12, 0);
...
(0, 12, 'biCod-12-ghhP', '2024-05-17', '8:02 am', NULL);
...
--
ALTER TABLE `table_cierre`
  MODIFY `id_table_cierre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `table_ticket_venta`
  MODIFY `id_ticket_venta` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
